    ...
    try {
      switch (event.type) {
        case 'checkout.session.completed': {
          ...
          // mode: 'subscription' não faz nada aqui — customer.subscription.created
          // chega logo em seguida já com o price resolvido.
          break;
        }
        ...
        default:
          // evento não assinado no Dashboard não deveria chegar aqui;
          // se chegar, só ignora.
          break;
      }
