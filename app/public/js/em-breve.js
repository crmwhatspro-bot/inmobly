...
const TEXTOS = {
  site:          { titulo: 'Meu Site',       desc: 'Aqui você vai poder pré-visualizar o site público do seu catálogo, escrever o texto de apresentação e publicar quando estiver pronto.' },
...
const activo = ['site', 'leads', 'dominio'].includes(params.get('f')) ? params.get('f') : null;
